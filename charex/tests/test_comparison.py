...
def main(method='graph'):
    ...
    CharacterTest(ch.numba_char_greater_equal, np.char.greater_equal, byte_args, string_args).run(method)
    CharacterTest(ch.numba_char_greater, np.char.greater, byte_args, string_args).run(method)
    CharacterTest(ch.numba_char_less, np.char.less, byte_args, string_args).run(method)
    CharacterTest(ch.numba_char_less_equal, np.char.less_equal, byte_args, string_args).run(method)
